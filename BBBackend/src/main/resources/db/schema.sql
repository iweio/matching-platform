-- 需求文档中的 `user` 表在实现中使用 app_user，避免 MySQL 保留字 user
CREATE DATABASE IF NOT EXISTS matching_db DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
USE matching_db;
...
-- character 列为 SQL 保留语义冲突，使用 character_label 存文档中的「性格类型」
